    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(mapboxMap -> {
            ...
            mapboxMap.setStyle(new Style.Builder().fromJson(styleJson), style -> {
                ...
                LatLng location1 = new LatLng(-7.771074965787361, 110.37755560012513);
                LatLng location2 = new LatLng(-7.7744963290420115, 110.39214787696041);
                LatLng location3 = new LatLng(-7.784337637152147, 110.3940656056097);
                LatLng location4 = new LatLng(-7.761596709775459, 110.40895479297458);
                LatLng location5 = new LatLng(-7.774198177563368, 110.38632630676159);
